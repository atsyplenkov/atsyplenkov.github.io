...
#show: template.with(
  ...
  description: "A quick Tidy Tuesday exploration of NHL career goal leaders, career length, and how total goals spread across career-length groups.",
  date: datetime(year: 2020, month: 3, day: 3),
  page-type: "blog-posting",
  keywords: ("R", "tidytuesday"),
  image-path: "/blog/2020-03-03-tidy-tuesday-nhl/figures/plot-1.png",
  image-alt: "Dumbbell chart of NHL career goal leaders and years active for the top 50 players",
  extra-info: [Categories: R, tidytuesday],
)

= Tidy Tuesday NHL

Okay, here it is. My first contribution to the my website. I'll try to make a very quick and simple data exploration analysis for this weeks' #link("https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-03-03/readme.md")[Tidy Tuesday]. There are three datasets available. I'm not sure that I'll be able to analyze all of them… Let's start from the first `top_250`.
...
I prefer to use discrete color scale instead of continuous. So I'm going to convert `total_goals` into factor. I really like to do it interactively with a new #link("https://juba.github.io/questionr/reference/icut.html")[questionr] package! So easy!
...
#figure(
  image("figures/plot-1.png", width: 80%),
  caption: [NHL career leaders and records for goals, top 50.],
)
...
#figure(
  image("figures/boxplot-1.png", width: 80%),
  caption: [Total goals scored across career-length groups for the top 250 players.],
)
